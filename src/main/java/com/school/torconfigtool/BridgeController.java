...
public class BridgeController {
    ...
    @Autowired
    public BridgeController(RelayService relayService, RelayOperationsController relayOperationController, NginxService nginxService, FileService fileService) {
